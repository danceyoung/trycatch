 ...
 * @Last Modified time: 2019-05-31 12:06:36
 */
...
export default class Home extends React.Component {
  ...
  _signin(event) {
    ...
    NetClient.netPost(global.tt_constant.net_url_signin, {
      account_name: this.state.email,
        ...
        <div className="ttHomeContent1">
          <div className="ttHomeContent1-left">
            ...
            <div style={{ fontSize: 12 }}>
              <img alt="" src={iOSQRImg} style={{ width: 60, height: 60 }} />
              <div>App Store</div>
            </div>
        ...
        <section className="ttContent2">
          <div style={{ flex: 1, display: "flex", flexDirection: "row" }}>
            ...
            <div className="ttContent2-div" style={{ marginLeft: 20 }}>
              ...
              <div className="ttContent2-div-right-div">
                <div className="ttContent2-div-right-div-title">Real-time</div>
                <div className="ttContent2-div-right-div-content">
                  Using Apache Flume Source watches the specified files, and
                  tails them in nearly real-time once detected new lines
                  appended to the each files. Customing Flume's HTTP Sink, send
                  those content what you marked to server.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="ttContent2-div" style={{ marginLeft: -20 }}>
              ...
              <div className="ttContent2-div-right-div">
                ...
                <div className="ttContent2-div-right-div-content">
                  ...
                  and login APP, upon receipt of information related you will be
                  immediately sent to your smart phone.
                </div>
              </div>
            </div>
            <div className="ttContent2-div" style={{ marginLeft: 20 }}>
          ...
          <div className="ttContent2-div" style={{ marginLeft: -20 }}>
            <div className="ttContent2-div-image">
              <img alt="" src={sloveImg} style={{ width: 100, height: 100 }} />
            </div>
            <div className="ttContent2-div-right-div">
              <div className="ttContent2-div-right-div-title">
                Finally solve
              ...
              <div className="ttContent2-div-right-div-content">
                Errors are found in your applications, finally you will solve
                these errors. If you can't solve, you can open them to seek
                helps, for example opening to StackOverFlow.
              </div>
            </div>
          </div>
        </section>
