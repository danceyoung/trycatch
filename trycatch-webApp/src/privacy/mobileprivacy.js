...
export default class MobilePrivacy extends Component {
  render() {
    return (
      <div style={{marginLeft: 20, marginRight: 20, flex: 1, flexDirection: 'column'}}>
        <h2>Privacy Policy</h2>{" "}
        <p>
          {" "}
          TryCatch info built the [Try Catch] app as a Free app. This
          SERVICE is provided by TryCatch info at no cost and is intended
          for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          our Terms and Conditions, which is accessible at [Try Catch]
        ...
        <p>email: danceyoung@hotmail.com</p>
      </div>
    );
  }
}